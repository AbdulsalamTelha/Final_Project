# Generated by Django 5.1.4 on 2024-12-31 17:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.PositiveIntegerField(validators=[django.core.validators.RegexValidator(message='Phone number must contain exactly 9 digits without any letters or special characters.', regex='^\\d{9}$')], verbose_name='phone number')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('course', models.ManyToManyField(limit_choices_to={'status': True}, related_name='instructors', to='admin_app.course')),
                ('department', models.ManyToManyField(blank=True, limit_choices_to={'status': True}, related_name='instructors', to='admin_app.department')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department', models.ForeignKey(blank=True, limit_choices_to={'status': True}, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='students', to='admin_app.department')),
                ('group', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='students', to='admin_app.group')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.BooleanField(default=True)),
                ('semester', models.CharField(choices=[('1', 'First'), ('2', 'Second')], default='1', max_length=50)),
                ...
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='student_courses', to='admin_app.student')),
            ],
        ),
        migrations.AddField(
            model_name='student',
